...
# Récupération du chemin d'acces aux images dans le fichier de config
config=configparser.ConfigParser()
chemin_courant=os.getcwd()
chemin_fichier_conf=chemin_courant+'\\fich_config.ini'
config.read(chemin_fichier_conf)
path=config['chemin_acces']['chem_mess_etoiles']+'telescope01\\*.png'
